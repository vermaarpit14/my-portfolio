...
const Skills = () => (
  <section
    id="skills"
    className="py-24 pb-24 px-6 md:px-[7vw] lg:px-[20vw] font-sans bg-skills-gradient clip-path-custom"
  >
    {/* Section Title */}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full">
              {category.skills.map((skill) => (
                ...
                >
                  ...
                  />
                  <span className="text-xs sm:text-sm text-gray-300 break-words whitespace-normal">
                    {skill.name}
                  </span>
                </div>
              ))}
